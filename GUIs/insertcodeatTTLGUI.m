...
tooltip1  = ['TTL duration: You may define a minimum duration of the square' char(10) ...
             'pulse to be considered a "true" trigger event. If you leave this window' char(10) ...
             'empty, ERPLAB will use a duration criteria equal to 1 sample.'];
tooltip2  = ['Event code to insert: You may define as many (numeric) event codes' char(10) ...
             'as TTL channels you defined. If you define one event codes and several' char(10) ...
             'TTL channels, ERPLAB will use this event code for all those channels.' char(10) ...
             'If you leave this window empty or you use NaN, ERPLAB will use the' char(10) ...
             'duration of each square pulse (in sample) as an event code. If you want' char(10) ...
             'to intermix fixed and "duration" event codes you may use numbers and' char(10) ...
             'NaNs, e.g. 100 NaN 12'];

...
handles.output = [];
 ...
 if strcmpi(dlg_title,'Recovering numeric event codes from Bin Labels')
         ...
         tooltip1  = ['You may want to differentiate between your recovered event codes' char(10) ...
                 'and those that were not bin-captured and that still remain in your dataset.' char(10) ...
                 'In order to do so, you can enter a single integer here that will work as a' char(10) ...
                 'multiplier for each recovered event code. For instance, if you use a value' char(10) ...
                 'of 100 then recovered event codes like 23 or 41 will appear as 2300 and 4100.' char(10) char(10) ...

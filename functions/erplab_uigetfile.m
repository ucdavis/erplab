% PURPOSE: uigetfile that leaves the calling window in front
%
% FORMAT:
%
% [filename, pathname, filterindex] = erplab_uigetfile(...)
%
% Takes and returns exactly what uigetfile does. The only difference is that the
...
function varargout = erplab_uigetfile(varargin)

...
if ~isempty(varargin)
        if length(varargin) == 1 | ~isstr(varargin{1}) | isempty(varargin{1}) | ...
                ...
                if nargin > 11,options = { options{:} 'XYcolor'  varargin{11} }; end;
...
axislcolor = g.XYcolor;
axcolor    = axislcolor; % find what the default x-axis color is
vertcolor  = axislcolor;
horicolor  = vertcolor;

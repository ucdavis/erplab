...
comSelectChannelInterpolation = [trystrs.no_check '[EEG, LASTCOM] = pop_erplabSelectChannelInterpolation(EEG);' catchstrs.new_and_hist];
...
uimenu( submenu ...
    ...
    ,'userdata', 'startup:on;continuous:on;epoch:off;study:off;erpset:off');
uimenu( submenu ...
    ,'Label'   , 'Select Channel Interpolation' ...
    ,'CallBack', comSelectChannelInterpolation ...
    ,'userdata', 'startup:on;continuous:on;epoch:off;study:off;erpset:off');

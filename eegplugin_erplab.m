...
%% eStudio info callback
eStudioInfo       = 'web https://github.com/ucdavis/erplab/wiki/ERPLAB-Studio-Overview -browser';
...
% ERPLAB Version line replaced by Estudio info
...
eStudioMenu = uimenu( submenu,                              ...
    'Label'    , 'Learn about our new ERPLAB Studio software',     ...
    'tag'      , 'estudio',                 ...
    'separator', 'off',                                      ...
    'CallBack' , eStudioInfo, ...
    'ForegroundColor', '#A020F0', ...

...
if nargin==1
        ...
        if isempty(ERP.bindata)
                ...
                title = 'ERPLAB: pop_calibraterp() error';
...
%         if ~ischar(erpinput)
%                 if erpinput==0
%                         erpcom = strrep(erpcom, 'ERPcal', 'ERP');
%                 elseif erpinput>0
%                         erpcom = strrep(erpcom, 'ERPcal', sprintf('ALLERP(%g)', erpinput));
%                 end
%         else
%                 erpcom = strrep(erpcom, 'ERPcal', sprintf('''%s''', erpinput));
%         end        
        return
end

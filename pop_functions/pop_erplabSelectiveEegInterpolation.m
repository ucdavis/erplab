function [outputEEG, commandHistory] = pop_erplabSelectiveEegInterpolation( EEG, varargin )
%pop_erplabSelectiveEegInterpolation In EEG data, replace specific channels through interpolation with the option to ignore specific channels
%
% FORMAT
%
...
%     outputEEG             = pop_erplabSelectiveEegInterpolation(EEG, replaceChannels, ignoreChannels, interpolationMethod);
%     
%
% Requirements:
...
%         displayFeedback });
    ...
    [outputEEG, commandHistory] = pop_erplabSelectiveEegInterpolation(EEG, ...

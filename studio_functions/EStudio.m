...
fprintf([32,'It took',32,num2str(timeElapsed),'s to launch EStudio.\n\n']);
    ...
    function EStudio_gui_erp_totl = createInterface()
        ...
        EStudio_gui_erp_totl.eeg_zoom_in_fivesmall = uicontrol('Parent',EStudio_gui_erp_totl.eeg_plot_button_title,'Style','pushbutton','String','-25X',...
            'FontSize',FonsizeDefault+1,'BackgroundColor',[1 1 1],'Enable','off');
        EStudio_gui_erp_totl.eeg_zoom_in_small = uicontrol('Parent',EStudio_gui_erp_totl.eeg_plot_button_title,'Style','pushbutton','String','-5X',...
            'FontSize',FonsizeDefault+1,'BackgroundColor',[1 1 1],'Enable','off');
        EStudio_gui_erp_totl.eeg_zoom_edit = uicontrol('Parent',EStudio_gui_erp_totl.eeg_plot_button_title,'Style','edit','String','',...
            'FontSize',FonsizeDefault+1,'BackgroundColor',[1 1 1],'Enable','off');
        EStudio_gui_erp_totl.eeg_zoom_out_small = uicontrol('Parent',EStudio_gui_erp_totl.eeg_plot_button_title,'Style','pushbutton','String','+5X',...
            'FontSize',FonsizeDefault+1,'BackgroundColor',[1 1 1],'Enable','off');
        EStudio_gui_erp_totl.eeg_zoom_out_fivelarge = uicontrol('Parent',EStudio_gui_erp_totl.eeg_plot_button_title,'Style','pushbutton','String','+25X',...
            'FontSize',FonsizeDefault+1,'BackgroundColor',[1 1 1],'Enable','off');

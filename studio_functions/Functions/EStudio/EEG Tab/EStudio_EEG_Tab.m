...
EStudio_gui_erp_totl.eegpanelSizes(7) = 360;
...
EStudio_gui_erp_totl.eegpanelSizes(8) = 320;
EStudio_gui_erp_totl.eegpanel{9} = f_EEG_chanoperation_GUI(EStudio_gui_erp_totl.eegsettingLayout,EStudio_gui_erp_totl.eegpanel_fonts);
EStudio_gui_erp_totl.eegpanelSizes(9) = 330;
...
EStudio_gui_erp_totl.eegpanel{11} = f_EEG_interpolate_chan_epoch_GUI(EStudio_gui_erp_totl.eegsettingLayout,EStudio_gui_erp_totl.eegpanel_fonts);
EStudio_gui_erp_totl.eegpanelSizes(11) = 270;

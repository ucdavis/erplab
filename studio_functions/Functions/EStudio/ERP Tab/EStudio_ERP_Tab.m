...
EStudio_gui_erp_totl.panel{1} = f_ERP_erpsetsGUI(EStudio_gui_erp_totl.settingLayout,EStudio_gui_erp_totl.FontSizeDefault);
EStudio_gui_erp_totl.panelSizes(1) = 330;
EStudio_gui_erp_totl.panel{2} = f_ERP_bin_channel_GUI(EStudio_gui_erp_totl.settingLayout,EStudio_gui_erp_totl.FontSizeDefault);
EStudio_gui_erp_totl.panelSizes(2) = 320;
EStudio_gui_erp_totl.panel{3} = f_ERP_plot_setting_GUI(EStudio_gui_erp_totl.settingLayout,EStudio_gui_erp_totl.FontSizeDefault);
EStudio_gui_erp_totl.panelSizes(3) = 390;
EStudio_gui_erp_totl.panel{4} = f_ERP_plot_scalp_GUI(EStudio_gui_erp_totl.settingLayout,EStudio_gui_erp_totl.FontSizeDefault);
EStudio_gui_erp_totl.panelSizes(4) = 398;
disp('ERP Tab: Launching ERPsets, Bin & Channel Selection, Plot Settings, Plot Scalp Maps,...');
EStudio_gui_erp_totl.panel{5} = f_ERP_edit_channel_GUI(EStudio_gui_erp_totl.settingLayout,EStudio_gui_erp_totl.FontSizeDefault);
EStudio_gui_erp_totl.panelSizes(5) = 190;
EStudio_gui_erp_totl.panel{6} = f_ERP_chanoperation_GUI(EStudio_gui_erp_totl.settingLayout,EStudio_gui_erp_totl.FontSizeDefault);
EStudio_gui_erp_totl.panelSizes(6) = 340;
EStudio_gui_erp_totl.panel{7} = f_erp_informtion_GUI(EStudio_gui_erp_totl.settingLayout,EStudio_gui_erp_totl.FontSizeDefault);
EStudio_gui_erp_totl.panelSizes(7) = 410;
EStudio_gui_erp_totl.panel{8} = f_ERP_resample_GUI(EStudio_gui_erp_totl.settingLayout,EStudio_gui_erp_totl.FontSizeDefault);
...
EStudio_gui_erp_totl.panel{9} = f_ERP_binoperation_GUI(EStudio_gui_erp_totl.settingLayout,EStudio_gui_erp_totl.FontSizeDefault);
EStudio_gui_erp_totl.panelSizes(9) = 290;
EStudio_gui_erp_totl.panel{10} = f_ERP_filtering_GUI(EStudio_gui_erp_totl.settingLayout,EStudio_gui_erp_totl.FontSizeDefault);
EStudio_gui_erp_totl.panelSizes(10) = 230;
EStudio_gui_erp_totl.panel{11} =  f_ERP_baselinecorr_detrend_GUI(EStudio_gui_erp_totl.settingLayout,EStudio_gui_erp_totl.FontSizeDefault);
EStudio_gui_erp_totl.panelSizes(11) = 220;
EStudio_gui_erp_totl.panel{12} = f_ERP_grandaverageGUI(EStudio_gui_erp_totl.settingLayout,EStudio_gui_erp_totl.FontSizeDefault);
...
EStudio_gui_erp_totl.panel{13} = f_ERP_append_GUI(EStudio_gui_erp_totl.settingLayout,EStudio_gui_erp_totl.FontSizeDefault);
EStudio_gui_erp_totl.panelSizes(13) = 120;
EStudio_gui_erp_totl.panel{14} = f_ERP_measurement_GUI(EStudio_gui_erp_totl.settingLayout,EStudio_gui_erp_totl.FontSizeDefault);
EStudio_gui_erp_totl.panelSizes(14) = 230;
EStudio_gui_erp_totl.panel{15} = f_ERP_events_GUI(EStudio_gui_erp_totl.settingLayout,EStudio_gui_erp_totl.FontSizeDefault);
EStudio_gui_erp_totl.panelSizes(15) = 100;
EStudio_gui_erp_totl.panel{16} = f_erp_dataquality_SME_GUI(EStudio_gui_erp_totl.settingLayout,EStudio_gui_erp_totl.FontSizeDefault);
EStudio_gui_erp_totl.panelSizes(16) = 220;
disp([32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,...
    'Append ERPsets, Measurement Tool, EventList, View Data Quality Metrics,...']);
EStudio_gui_erp_totl.panel{17} = f_ERP_CSD_GUI(EStudio_gui_erp_totl.settingLayout,EStudio_gui_erp_totl.FontSizeDefault);
EStudio_gui_erp_totl.panelSizes(17) = 190;
EStudio_gui_erp_totl.panel{18} = f_ERP_spectral_GUI(EStudio_gui_erp_totl.settingLayout,EStudio_gui_erp_totl.FontSizeDefault);
EStudio_gui_erp_totl.panelSizes(18) = 160;
EStudio_gui_erp_totl.panel{19} = f_ERP_simulation_panel(EStudio_gui_erp_totl.settingLayout,EStudio_gui_erp_totl.FontSizeDefault);
EStudio_gui_erp_totl.panelSizes(19) = 820;
EStudio_gui_erp_totl.panel{20} =  f_ERP_history_GUI(EStudio_gui_erp_totl.settingLayout,EStudio_gui_erp_totl.FontSizeDefault);
...
EStudio_gui_erp_totl.pageinfo_minus = uicontrol('Parent',pageinfo_box,'Style', 'pushbutton', 'String', 'Prev.','FontSize',FontSizeDefault,'BackgroundColor',[1 1 1],'Enable','off');
EStudio_gui_erp_totl.pageinfo_edit = uicontrol('Parent',pageinfo_box,'Style', 'edit', 'String', num2str(pagecurrentNum),'FontSize',FontSizeDefault+2,'BackgroundColor',[1 1 1],'Enable','off');
EStudio_gui_erp_totl.pageinfo_plus = uicontrol('Parent',pageinfo_box,'Style', 'pushbutton', 'String', 'Next','FontSize',FontSizeDefault,'BackgroundColor',[1 1 1],'Enable','off');

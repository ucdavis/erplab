...
if ~isempty(MyViewer_ERPset) && MyViewer_ERPset==1
    messgStr  = char( 'Changes in "ERPsets" have not been applied');
    viewerpanelIndex =1;
end
...
if ~isempty(MyViewer_ERPset) && MyViewer_chanbin==1
    messgStr  = char( 'Changes in "Channels and Bins" have not been applied');
    viewerpanelIndex =2;
end
...
if ~isempty(MyViewer_ERPset) && MyViewer_xyaxis==1
    messgStr  = char( 'Changes in "Time and Amplitude Scales" have not been applied');
    viewerpanelIndex =3;
end
...
if ~isempty(MyViewer_ERPset) && MyViewer_other==1
    messgStr  = char( 'Changes in "Other" have not been applied');
    viewerpanelIndex =7;
end

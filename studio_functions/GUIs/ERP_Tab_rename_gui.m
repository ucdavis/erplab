% ERP_Tab_rename_gui
% Rename ERPset dialog for ERPLAB Studio ERP Tab.
%
...
% original ERP_Tab_rename_gui.mlapp has been archived outside the ERPLAB
...
classdef ERP_Tab_rename_gui < matlab.apps.AppBase
    ...
    properties (Access = public)
        Output        % New erpnames cell array, or [] if cancelled
    ...
    methods (Access = private)
        ...
        function startupFcn(app, varargin)
            ...
            set(app.UIFigure, 'Name', ['Estudio ' version '   -   Rename ERP files GUI']);
            ...
            for Numoferp = 1:numel(ALLERP)
                ...
                data{Numoferp,1}   = ALLERP(Numoferp).erpname;
                data{Numoferp,2}   = ALLERP(Numoferp).erpname;
            end
        ...
        function apply(app, ~)
            ...
            for Numoferp = 1:numel(ALLERP)
                ...
                if ~isempty(newName)
                    erpname{Numoferp} = newName;
                else
                    erpname{Numoferp} = ALLERP(Numoferp).erpname;
                end
            end
            app.Output        = erpname;
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            % Table showing original / new erpnames
            app.UITable                    = uitable(app.UIFigure);
            app.UITable.ColumnName         = {'Original erpname'; 'New erpname'};
            app.UITable.RowName            = {};
    ...
    methods (Access = public)
        ...
        function app = ERP_Tab_rename_gui(varargin)

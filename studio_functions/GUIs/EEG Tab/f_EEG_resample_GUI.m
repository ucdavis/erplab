...
%%--------------------------Trim continuous data---------------------------
    function Trimcont(~,~)
        ...
        estudioworkingmemory('f_EEG_proces_messg','Sampling Rate & Epoch>Trim continuous data');
        observe_EEGDAT.eeg_panel_message =1; %%Marking for the procedure has been started.
        
        def    = estudioworkingmemory('pop_eegtrim');
        ...
        presti  = answer{1};
        poststi = answer{2};
        estudioworkingmemory('pop_eegtrim', {answer{1} answer{2}});

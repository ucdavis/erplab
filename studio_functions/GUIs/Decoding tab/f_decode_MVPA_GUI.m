...
elseif nargin == 1
    ...
    box_bestset_gui = uiextras.BoxPanel('Parent', varargin{1}, 'Title', 'Multivariate Pattern Classification', 'Padding', 5, 'FontUnits','pixels','FontSize', varargin{2},'BackgroundColor',ColorB_def);
end

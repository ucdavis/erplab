...
handles.ERP_M_T_Viewer_table.FontSize = FontSizeDefault;
        ...
        if plotdatalabel ~=0 && plotdatalabel<= numel(plotArray) && ~isempty(plotbindata)
            ...
            for iCount = 1:nYTicks
                ...
                text(waveview,myY_Crossing-2*abs(ytick_bottom),props.YTick(iCount),  ...
                    ...
                    'FontUnits','pixels','FontSize', FontSizeDefault, ...
...
if ~isempty(hplot)
    if chanOverlay==0
        ...
        set(h_legend,'NumColumns',1,'FontName', fontnames, 'Color', [1 1 1], 'position', p,'FontUnits','pixels','FontSize',FontSizeDefault,'box','off');
    else
        %         qLegendName = {'There are no legend names becuase you selected "Overlay" for chans'};
        %         text(legendview,0.5,0.8,qLegendName ,...
        %             'FontSize',FontSizeDefault+2,'HorizontalAlignment', 'center',  'Color', [1 0 0]);
    end
end

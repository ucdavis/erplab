...
%
foldernum = regexp(p,'erplab_beta_(\d+\.+\d+\.+\d+\.+\d+)', 'tokens', 'ignorecase');
...
uimenu( ELmenu, 'Label',  '<html>Export Reaction Times to Text from <b>EEG</b>'  , 'CallBack', comEXRTeeg); % Reaction Times
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%         MENU     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
uimenu( submenu, 'Label', 'help', 'CallBack', comhelp, 'separator', 'on');

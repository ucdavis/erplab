...
%
% The purpose of this function is to allow multiple dataset loading, while
% user is working on the EEGLAB GUI.
% Do not use this function in scripting. Use pop_loadset() with a for loop instead.
%
% See pop_loadset eeg_store
%

...
% Useful for a counting histogram of your event codes (you have to work with EEGLAB/ERPLAB of course).
%
% Example:
%
...
outstr    = cellstr([char(eventtypes) repmat(' = ', length(eventtypes),1) char(histstr)]);
